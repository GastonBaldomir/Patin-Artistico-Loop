        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatinadoraId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VinculosFamiliares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VinculosFamiliares_AspNetUsers_PatinadoraId",
                        column: x => x.PatinadoraId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VinculosFamiliares_AspNetUsers_TutorId",
                        column: x => x.TutorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VinculosFamiliares_PatinadoraId",
                table: "VinculosFamiliares",
                column: "PatinadoraId");

            migrationBuilder.CreateIndex(
                name: "IX_VinculosFamiliares_TutorId",
                table: "VinculosFamiliares",
                column: "TutorId");
        }
